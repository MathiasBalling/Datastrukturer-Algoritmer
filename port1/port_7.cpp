/*6561 er et eksempel pả et naturligt tal, som kan skrives som X^Y hvor X og Y
er heltal, dvs. 9^4. Et andet eksempel er 3125 (55). Skriv en algoritme, som kan
afgore om et givent naturligt tal Z < 100,000 (algoritmens parameter) kan
skrives som Z=X^Y hvor X og Y er heltal, hvorom det galder, at X > 2 0g Y > 2.

Algoritmens returvardi skal designes således, at folgende information kan
udledes fra den:
